...
#ifndef SRC_TINYGSMCLIENTME91_H_
#define SRC_TINYGSMCLIENTME91_H_
// #pragma message("TinyGSM:  TinyGsmClientME91")
...
class TinyGsmME91 : public TinyGsmModem<TinyGsmME91>,
                    public TinyGsmGPRS<TinyGsmME91>,
                    public TinyGsmTCP<TinyGsmME91, TINY_GSM_MUX_COUNT>,
                    public TinyGsmCalling<TinyGsmME91>,
                    public TinyGsmSMS<TinyGsmME91>,
                    public TinyGsmTime<TinyGsmME91>,
                    public TinyGsmNTP<TinyGsmME91>,
                    public TinyGsmGPS<TinyGsmME91>,
                    public TinyGsmBattery<TinyGsmME91>,
                    public TinyGsmTemperature<TinyGsmME91> {
  friend class TinyGsmModem<TinyGsmME91>;
  friend class TinyGsmGPRS<TinyGsmME91>;
  friend class TinyGsmTCP<TinyGsmME91, TINY_GSM_MUX_COUNT>;
  friend class TinyGsmCalling<TinyGsmME91>;
  friend class TinyGsmSMS<TinyGsmME91>;
  friend class TinyGsmTime<TinyGsmME91>;
  friend class TinyGsmNTP<TinyGsmME91>;
  friend class TinyGsmGPS<TinyGsmME91>;
  friend class TinyGsmBattery<TinyGsmME91>;
  friend class TinyGsmTemperature<TinyGsmME91>;

  /*
   * Inner Client
   */
 public:
  class GsmClientME91 : public GsmClient {
    friend class TinyGsmME91;

   public:
    GsmClientME91() {}

    explicit GsmClientME91(TinyGsmME91& modem, uint8_t mux = 0) {
      init(&modem, mux);
    }

    bool init(TinyGsmME91* modem, uint8_t mux = 0) {
      this->at       = modem;
      sock_available = 0;
      prev_check     = 0;
  ...
  /*
  class GsmClientSecureME91 : public GsmClientME91
  {
  public:
    GsmClientSecure() {}

    GsmClientSecure(TinyGsmME91& modem, uint8_t mux = 0)
  ...
  */
   ...
   */
 public:
  explicit TinyGsmME91(Stream& stream) : stream(stream) {
 ...
 protected:
  bool initImpl(const char* pin = NULL) {
    ...
    DBG(GF("### TinyGSM Compiled Module:  TinyGsmClientME91"));
...
#else
    sendAT(GF("+CMEE=2"));  // turn off error codes
#endif
    waitResponse();
 ...
 protected:
  ...
  // The ME91 returns UTC time instead of local time as other modules do in
 ...
 protected:
  GsmClientME91* sockets[TINY_GSM_MUX_COUNT];
  const char*    gsmNL = GSM_NL;
};

#endif  // SRC_TINYGSMCLIENTME91_H_
